...
<div class="flex items-center justify-between gap-4 px-4 py-3 border-b border-slate-800/80 hover:bg-slate-800/40 transition-all cursor-default border-l-2 border-l-orange-500/0 hover:border-l-orange-500/60">
	...
	<div class="flex-1 min-w-0 flex justify-end overflow-x-auto no-scrollbar">
		<OddsColumns {match} />
	</div>
</div>
